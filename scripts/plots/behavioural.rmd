...
```{r fixel-based}
residuals <- read.csv(here("data", "brain", "fixel", "subcortical_cortical_regression.csv"))
...
fixel <- data.frame(
  ...
  "strial_precentral" = residuals$isochrony_introduced_600_5_ST_PREC_fd_X_partial_resid,
  "thalamus_precentral" = residuals$isochrony_introduced_600_5_T_PREC_fd_X_partial_resid
)
