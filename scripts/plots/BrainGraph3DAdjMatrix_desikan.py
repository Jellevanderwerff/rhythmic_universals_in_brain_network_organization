...
mat_data = scipy.io.loadmat(data_path / 'consensus_neg_composite_entropy_diff_norm_q_avg_k10.mat')
matrix = mat_data['binary_consensus_neg']

# Load the coordinates csv data
coords_data = pd.read_csv(project_root / 'scripts' / 'neuroplot' / 'dk_mni_coordinates.csv')
...
colors_data = pd.read_csv(data_path / 'sortedDataTable_colors_shirer_subcortical.csv')
