...
```{r write-out}
write.csv(ITIs, here("data", "pilot", "processed", "ITIs.csv"), row.names = FALSE)
write.csv(ITIs.bytrial, here("data", "pilot", "processed", "ITIs_bytrial.csv"), row.names = FALSE)
```
...
python3 ./scripts/additional_measures/calculate_editdistance_pilot.py
python3 ./scripts/additional_measures/calculate_entropy_pilot.py
python3 ./scripts/additional_measures/calculate_G_measure_pilot.py
python3 ./scripts/additional_measures/calculate_rhythmic_contours_pilot.py
python3 ./scripts/additional_measures/pp_measures_pilot.py
