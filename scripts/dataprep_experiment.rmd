...
here::i_am(file.path('scripts', 'dataprep_pilot.rmd'))
...
saveRDS(ITIs, here('data', 'experiment', 'processed', 'ITIs.rds'))
write.csv(ITIs, here('data', 'experiment', 'processed', 'ITIs.csv'))

saveRDS(ITIs.bytrial, here('data', 'experiment', 'processed', 'ITIs_bytrial.rds'))
write.csv(ITIs.bytrial, here('data', 'experiment', 'processed', 'ITIs_bytrial.csv'))
