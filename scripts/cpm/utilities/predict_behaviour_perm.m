function [behav_pred_pos,behav_pred_neg,R_pos,R_neg] = predict_behaviour_WB(all_mats, new_behav, no_nodes, no_subj, thresh, corr_method)
...
[R_pos,P_pos] = corr(behav_pred_pos,new_behav);
[R_neg,P_neg] = corr(behav_pred_neg,new_behav);
